    ...
    <>
      <header className="public-header">
        ...
        <nav>
          ...
          <Button onClick={() => go('register')}>Open an account</Button>
        </nav>
      </header>
      <main className="home">
        <section className="hero">
          <div>
            ...
            <div className="actions">
              <Button onClick={() => go('register')}>Open an account <I.ArrowRight /></Button>
              <Button variant="light" onClick={() => go('login')}>Sign in</Button>
            </div>
            <p className="sandbox">◉ NEXA is a controlled financial platform.</p>
          </div>
      ...
      <footer>
        © 2026 NEXA Microfinance Bank <span>•</span> About <span>•</span> Security <span>•</span> Support <span>•</span> Privacy
      </footer>
    </>
  );
}
